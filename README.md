### Note: current version is 1.3.4, please reload the db again (delete db and initialize again) due to some new features if you're going to update the explorer. 
